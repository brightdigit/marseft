...
//  Marseft
//
//  Created by Leo Dion on 7/1/16.
//  Copyright © 2016 Leo G Dion. All rights reserved.
//

import Foundation

extension Data {
  internal static func libzOpen () -> UnsafeMutablePointer<Void> {
    //  static void *libz;
    ...
    //  });
    //  return libz;
    return dlopen("/usr/lib/libz.dylib", RTLD_LAZY)
  }
  
  public func gzippedData(withCompressionLevel level: Float) -> Data {
...
//  }
//  
  public var isGzippedData:Bool {
    get {
      //  const UInt8 *bytes = (const UInt8 *)self.bytes;
      //  return (self.length >= 2 && bytes[0] == 0x1f && bytes[1] == 0x8b);
      var bytes
      self.copyBytes(to: <#T##UnsafeMutableBufferPointer<DestinationType>#>)
